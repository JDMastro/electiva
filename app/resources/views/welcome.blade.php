...
<body>
    ...
    <div class="">
        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="#">ELECTIVA II</a>
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                    ...
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item">
                            <a href="{{ route('login') }}" class="nav-link" tabindex="-1" aria-disabled="true">Log
                                in</a>
                        </li>

                        @if (Route::has('register'))
                        <li><a href="{{ route('register') }}" class="nav-link" tabindex="-1"
                                aria-disabled="true">Register</a></li>
                        @endif
                    </ul>
